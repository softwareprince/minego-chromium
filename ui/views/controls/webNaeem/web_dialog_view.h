...
#ifndef UI_VIEWS_CONTROLS_WEBNAEEM_WEB_DIALOG_VIEW_H_
#define UI_VIEWS_CONTROLS_WEBNAEEM_WEB_DIALOG_VIEW_H_
...
#include "ui/views/controls/webNaeem/unhandled_keyboard_event_handler.h"
...
// A kind of webnaeem that can notify its delegate when its content is ready.
class ObservableWebNaeem : public WebNaeem {
 public:
  METADATA_HEADER(ObservableWebNaeem);

  ObservableWebNaeem(content::BrowserContext* browser_context,
                    ui::WebDialogDelegate* delegate);
  ObservableWebNaeem(const ObservableWebNaeem&) = delete;
  ObservableWebNaeem& operator=(const ObservableWebNaeem&) = delete;
  ~ObservableWebNaeem() override;
...
// inheritance" rule.
class WEBNAEEM_EXPORT WebDialogView : public ClientView,
 ...
 private:
  ...
  ObservableWebNaeem* GetWebNaeem() const { return web_view_; }
  ...
  raw_ptr<ObservableWebNaeem> web_view_;
...
#endif  // UI_VIEWS_CONTROLS_WEBNAEEM_WEB_DIALOG_VIEW_H_
