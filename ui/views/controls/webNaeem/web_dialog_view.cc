...
#include "ui/views/controls/webNaeem/web_dialog_view.h"
...
ObservableWebNaeem::ObservableWebNaeem(content::BrowserContext* browser_context,
                                     WebDialogDelegate* delegate)
    : WebNaeem(browser_context), delegate_(delegate) {}

ObservableWebNaeem::~ObservableWebNaeem() = default;

void ObservableWebNaeem::DidFinishLoad(
...
void ObservableWebNaeem::ResetDelegate() {
  delegate_ = nullptr;
}

BEGIN_METADATA(ObservableWebNaeem, WebNaeem)
END_METADATA
...
WebDialogView::WebDialogView(content::BrowserContext* context,
    ...
    : ClientView(nullptr, nullptr),
      ...
      delegate_(delegate),
      web_view_(new ObservableWebNaeem(context, delegate)) {
...
ADD_READONLY_PROPERTY_METADATA(ObservableWebNaeem*, WebNaeem);
END_METADATA
