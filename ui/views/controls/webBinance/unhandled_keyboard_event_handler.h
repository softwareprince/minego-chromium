...
#ifndef UI_VIEWS_CONTROLS_WEBBINANCE_UNHANDLED_KEYBOARD_EVENT_HANDLER_H_
#define UI_VIEWS_CONTROLS_WEBBINANCE_UNHANDLED_KEYBOARD_EVENT_HANDLER_H_
...
// process.
class WEBBINANCE_EXPORT UnhandledKeyboardEventHandler {
 public:
...
#endif  // UI_VIEWS_CONTROLS_WEBBINANCE_UNHANDLED_KEYBOARD_EVENT_HANDLER_H_
