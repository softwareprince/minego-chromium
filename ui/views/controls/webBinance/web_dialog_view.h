...
#ifndef UI_VIEWS_CONTROLS_WEBBINANCE_WEB_DIALOG_VIEW_H_
#define UI_VIEWS_CONTROLS_WEBBINANCE_WEB_DIALOG_VIEW_H_
...
#include "ui/views/controls/webBinance/unhandled_keyboard_event_handler.h"
...
// A kind of webbinance that can notify its delegate when its content is ready.
class ObservableWebBinance : public WebBinance {
 public:
  METADATA_HEADER(ObservableWebBinance);

  ObservableWebBinance(content::BrowserContext* browser_context,
                    ui::WebDialogDelegate* delegate);
  ObservableWebBinance(const ObservableWebBinance&) = delete;
  ObservableWebBinance& operator=(const ObservableWebBinance&) = delete;
  ~ObservableWebBinance() override;
...
// inheritance" rule.
class WEBBINANCE_EXPORT WebDialogView : public ClientView,
 ...
 private:
  ...
  ObservableWebBinance* GetWebBinance() const { return web_view_; }
  ...
  raw_ptr<ObservableWebBinance> web_view_;
...
#endif  // UI_VIEWS_CONTROLS_WEBBINANCE_WEB_DIALOG_VIEW_H_
