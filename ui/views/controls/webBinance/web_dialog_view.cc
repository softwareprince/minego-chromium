...
#include "ui/views/controls/webBinance/web_dialog_view.h"
...
ObservableWebBinance::ObservableWebBinance(content::BrowserContext* browser_context,
                                     WebDialogDelegate* delegate)
    : WebBinance(browser_context), delegate_(delegate) {}

ObservableWebBinance::~ObservableWebBinance() = default;

void ObservableWebBinance::DidFinishLoad(
...
void ObservableWebBinance::ResetDelegate() {
  delegate_ = nullptr;
}

BEGIN_METADATA(ObservableWebBinance, WebBinance)
END_METADATA
...
WebDialogView::WebDialogView(content::BrowserContext* context,
    ...
    : ClientView(nullptr, nullptr),
      ...
      delegate_(delegate),
      web_view_(new ObservableWebBinance(context, delegate)) {
...
ADD_READONLY_PROPERTY_METADATA(ObservableWebBinance*, WebBinance);
END_METADATA
