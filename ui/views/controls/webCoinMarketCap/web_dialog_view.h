...
#ifndef UI_VIEWS_CONTROLS_WEBCOINMARKETCAP_WEB_DIALOG_VIEW_H_
#define UI_VIEWS_CONTROLS_WEBCOINMARKETCAP_WEB_DIALOG_VIEW_H_
...
#include "ui/views/controls/webCoinMarketCap/unhandled_keyboard_event_handler.h"
...
// A kind of webcoinmarketcap that can notify its delegate when its content is ready.
class ObservableWebCoinMarketCap : public WebCoinMarketCap {
 public:
  METADATA_HEADER(ObservableWebCoinMarketCap);

  ObservableWebCoinMarketCap(content::BrowserContext* browser_context,
                    ui::WebDialogDelegate* delegate);
  ObservableWebCoinMarketCap(const ObservableWebCoinMarketCap&) = delete;
  ObservableWebCoinMarketCap& operator=(const ObservableWebCoinMarketCap&) = delete;
  ~ObservableWebCoinMarketCap() override;
...
// inheritance" rule.
class WEBCOINMARKETCAP_EXPORT WebDialogView : public ClientView,
 ...
 private:
  ...
  ObservableWebCoinMarketCap* GetWebCoinMarketCap() const { return web_view_; }
  ...
  raw_ptr<ObservableWebCoinMarketCap> web_view_;
...
#endif  // UI_VIEWS_CONTROLS_WEBCOINMARKETCAP_WEB_DIALOG_VIEW_H_
