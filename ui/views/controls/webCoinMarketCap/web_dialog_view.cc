...
#include "ui/views/controls/webCoinMarketCap/web_dialog_view.h"
...
ObservableWebCoinMarketCap::ObservableWebCoinMarketCap(content::BrowserContext* browser_context,
                                     WebDialogDelegate* delegate)
    : WebCoinMarketCap(browser_context), delegate_(delegate) {}

ObservableWebCoinMarketCap::~ObservableWebCoinMarketCap() = default;

void ObservableWebCoinMarketCap::DidFinishLoad(
...
void ObservableWebCoinMarketCap::ResetDelegate() {
  delegate_ = nullptr;
}

BEGIN_METADATA(ObservableWebCoinMarketCap, WebCoinMarketCap)
END_METADATA
...
WebDialogView::WebDialogView(content::BrowserContext* context,
    ...
    : ClientView(nullptr, nullptr),
      ...
      delegate_(delegate),
      web_view_(new ObservableWebCoinMarketCap(context, delegate)) {
...
ADD_READONLY_PROPERTY_METADATA(ObservableWebCoinMarketCap*, WebCoinMarketCap);
END_METADATA
