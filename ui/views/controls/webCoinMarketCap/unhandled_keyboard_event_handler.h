...
#ifndef UI_VIEWS_CONTROLS_WEBCOINMARKETCAP_UNHANDLED_KEYBOARD_EVENT_HANDLER_H_
#define UI_VIEWS_CONTROLS_WEBCOINMARKETCAP_UNHANDLED_KEYBOARD_EVENT_HANDLER_H_
...
// process.
class WEBCOINMARKETCAP_EXPORT UnhandledKeyboardEventHandler {
 public:
...
#endif  // UI_VIEWS_CONTROLS_WEBCOINMARKETCAP_UNHANDLED_KEYBOARD_EVENT_HANDLER_H_
