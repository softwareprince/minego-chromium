...
#include "ui/views/controls/webFacebookMessenger/web_dialog_view.h"
...
ObservableWebFacebookMessenger::ObservableWebFacebookMessenger(content::BrowserContext* browser_context,
                                     WebDialogDelegate* delegate)
    : WebFacebookMessenger(browser_context), delegate_(delegate) {}

ObservableWebFacebookMessenger::~ObservableWebFacebookMessenger() = default;

void ObservableWebFacebookMessenger::DidFinishLoad(
...
void ObservableWebFacebookMessenger::ResetDelegate() {
  delegate_ = nullptr;
}

BEGIN_METADATA(ObservableWebFacebookMessenger, WebFacebookMessenger)
END_METADATA
...
WebDialogView::WebDialogView(content::BrowserContext* context,
    ...
    : ClientView(nullptr, nullptr),
      ...
      delegate_(delegate),
      web_view_(new ObservableWebFacebookMessenger(context, delegate)) {
...
ADD_READONLY_PROPERTY_METADATA(ObservableWebFacebookMessenger*, WebFacebookMessenger);
END_METADATA
