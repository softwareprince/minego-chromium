...
#ifndef UI_VIEWS_CONTROLS_WEBFACEBOOKMESSENGER_WEB_DIALOG_VIEW_H_
#define UI_VIEWS_CONTROLS_WEBFACEBOOKMESSENGER_WEB_DIALOG_VIEW_H_
...
#include "ui/views/controls/webFacebookMessenger/unhandled_keyboard_event_handler.h"
...
// A kind of webfacebookmessenger that can notify its delegate when its content is ready.
class ObservableWebFacebookMessenger : public WebFacebookMessenger {
 public:
  METADATA_HEADER(ObservableWebFacebookMessenger);

  ObservableWebFacebookMessenger(content::BrowserContext* browser_context,
                    ui::WebDialogDelegate* delegate);
  ObservableWebFacebookMessenger(const ObservableWebFacebookMessenger&) = delete;
  ObservableWebFacebookMessenger& operator=(const ObservableWebFacebookMessenger&) = delete;
  ~ObservableWebFacebookMessenger() override;
...
// inheritance" rule.
class WEBFACEBOOKMESSENGER_EXPORT WebDialogView : public ClientView,
 ...
 private:
  ...
  ObservableWebFacebookMessenger* GetWebFacebookMessenger() const { return web_view_; }
  ...
  raw_ptr<ObservableWebFacebookMessenger> web_view_;
...
#endif  // UI_VIEWS_CONTROLS_WEBFACEBOOKMESSENGER_WEB_DIALOG_VIEW_H_
