...
#ifndef UI_VIEWS_CONTROLS_WEBTELEGRAM_WEB_DIALOG_VIEW_H_
#define UI_VIEWS_CONTROLS_WEBTELEGRAM_WEB_DIALOG_VIEW_H_
...
#include "ui/views/controls/webTelegram/unhandled_keyboard_event_handler.h"
...
// A kind of webtelegram that can notify its delegate when its content is ready.
class ObservableWebTelegram : public WebTelegram {
 public:
  METADATA_HEADER(ObservableWebTelegram);

  ObservableWebTelegram(content::BrowserContext* browser_context,
                    ui::WebDialogDelegate* delegate);
  ObservableWebTelegram(const ObservableWebTelegram&) = delete;
  ObservableWebTelegram& operator=(const ObservableWebTelegram&) = delete;
  ~ObservableWebTelegram() override;
...
// inheritance" rule.
class WEBTELEGRAM_EXPORT WebDialogView : public ClientView,
 ...
 private:
  ...
  ObservableWebTelegram* GetWebTelegram() const { return web_view_; }
  ...
  raw_ptr<ObservableWebTelegram> web_view_;
...
#endif  // UI_VIEWS_CONTROLS_WEBTELEGRAM_WEB_DIALOG_VIEW_H_
