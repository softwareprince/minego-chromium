...
#ifndef UI_VIEWS_CONTROLS_WEBDISCORD_WEB_DIALOG_VIEW_H_
#define UI_VIEWS_CONTROLS_WEBDISCORD_WEB_DIALOG_VIEW_H_
...
#include "ui/views/controls/webDiscord/unhandled_keyboard_event_handler.h"
...
// A kind of webdiscord that can notify its delegate when its content is ready.
class ObservableWebDiscord : public WebDiscord {
 public:
  METADATA_HEADER(ObservableWebDiscord);

  ObservableWebDiscord(content::BrowserContext* browser_context,
                    ui::WebDialogDelegate* delegate);
  ObservableWebDiscord(const ObservableWebDiscord&) = delete;
  ObservableWebDiscord& operator=(const ObservableWebDiscord&) = delete;
  ~ObservableWebDiscord() override;
...
// inheritance" rule.
class WEBDISCORD_EXPORT WebDialogView : public ClientView,
 ...
 private:
  ...
  ObservableWebDiscord* GetWebDiscord() const { return web_view_; }
  ...
  raw_ptr<ObservableWebDiscord> web_view_;
...
#endif  // UI_VIEWS_CONTROLS_WEBDISCORD_WEB_DIALOG_VIEW_H_
