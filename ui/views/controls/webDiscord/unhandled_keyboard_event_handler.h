...
#ifndef UI_VIEWS_CONTROLS_WEBDISCORD_UNHANDLED_KEYBOARD_EVENT_HANDLER_H_
#define UI_VIEWS_CONTROLS_WEBDISCORD_UNHANDLED_KEYBOARD_EVENT_HANDLER_H_
...
// process.
class WEBDISCORD_EXPORT UnhandledKeyboardEventHandler {
 public:
...
#endif  // UI_VIEWS_CONTROLS_WEBDISCORD_UNHANDLED_KEYBOARD_EVENT_HANDLER_H_
