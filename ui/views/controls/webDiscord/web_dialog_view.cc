...
#include "ui/views/controls/webDiscord/web_dialog_view.h"
...
ObservableWebDiscord::ObservableWebDiscord(content::BrowserContext* browser_context,
                                     WebDialogDelegate* delegate)
    : WebDiscord(browser_context), delegate_(delegate) {}

ObservableWebDiscord::~ObservableWebDiscord() = default;

void ObservableWebDiscord::DidFinishLoad(
...
void ObservableWebDiscord::ResetDelegate() {
  delegate_ = nullptr;
}

BEGIN_METADATA(ObservableWebDiscord, WebDiscord)
END_METADATA
...
WebDialogView::WebDialogView(content::BrowserContext* context,
    ...
    : ClientView(nullptr, nullptr),
      ...
      delegate_(delegate),
      web_view_(new ObservableWebDiscord(context, delegate)) {
...
ADD_READONLY_PROPERTY_METADATA(ObservableWebDiscord*, WebDiscord);
END_METADATA
