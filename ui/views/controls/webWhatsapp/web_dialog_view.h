...
#ifndef UI_VIEWS_CONTROLS_WEBWHATSAPP_WEB_DIALOG_VIEW_H_
#define UI_VIEWS_CONTROLS_WEBWHATSAPP_WEB_DIALOG_VIEW_H_
...
#include "ui/views/controls/webWhatsapp/unhandled_keyboard_event_handler.h"
...
// A kind of webwhatsapp that can notify its delegate when its content is ready.
class ObservableWebWhatsapp : public WebWhatsapp {
 public:
  METADATA_HEADER(ObservableWebWhatsapp);

  ObservableWebWhatsapp(content::BrowserContext* browser_context,
                    ui::WebDialogDelegate* delegate);
  ObservableWebWhatsapp(const ObservableWebWhatsapp&) = delete;
  ObservableWebWhatsapp& operator=(const ObservableWebWhatsapp&) = delete;
  ~ObservableWebWhatsapp() override;
...
// inheritance" rule.
class WEBWHATSAPP_EXPORT WebDialogView : public ClientView,
 ...
 private:
  ...
  ObservableWebWhatsapp* GetWebWhatsapp() const { return web_view_; }
  ...
  raw_ptr<ObservableWebWhatsapp> web_view_;
...
#endif  // UI_VIEWS_CONTROLS_WEBWHATSAPP_WEB_DIALOG_VIEW_H_
