...
#ifndef UI_VIEWS_CONTROLS_WEBWHATSAPP_UNHANDLED_KEYBOARD_EVENT_HANDLER_H_
#define UI_VIEWS_CONTROLS_WEBWHATSAPP_UNHANDLED_KEYBOARD_EVENT_HANDLER_H_
...
// process.
class WEBWHATSAPP_EXPORT UnhandledKeyboardEventHandler {
 public:
...
#endif  // UI_VIEWS_CONTROLS_WEBWHATSAPP_UNHANDLED_KEYBOARD_EVENT_HANDLER_H_
