...
#include "ui/views/controls/webWhatsapp/web_dialog_view.h"
...
ObservableWebWhatsapp::ObservableWebWhatsapp(content::BrowserContext* browser_context,
                                     WebDialogDelegate* delegate)
    : WebWhatsapp(browser_context), delegate_(delegate) {}

ObservableWebWhatsapp::~ObservableWebWhatsapp() = default;

void ObservableWebWhatsapp::DidFinishLoad(
...
void ObservableWebWhatsapp::ResetDelegate() {
  delegate_ = nullptr;
}

BEGIN_METADATA(ObservableWebWhatsapp, WebWhatsapp)
END_METADATA
...
WebDialogView::WebDialogView(content::BrowserContext* context,
    ...
    : ClientView(nullptr, nullptr),
      ...
      delegate_(delegate),
      web_view_(new ObservableWebWhatsapp(context, delegate)) {
...
ADD_READONLY_PROPERTY_METADATA(ObservableWebWhatsapp*, WebWhatsapp);
END_METADATA
