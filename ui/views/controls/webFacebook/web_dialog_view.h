...
#ifndef UI_VIEWS_CONTROLS_WEBFACEBOOK_WEB_DIALOG_VIEW_H_
#define UI_VIEWS_CONTROLS_WEBFACEBOOK_WEB_DIALOG_VIEW_H_
...
#include "ui/views/controls/webFacebook/unhandled_keyboard_event_handler.h"
...
// A kind of webfacebook that can notify its delegate when its content is ready.
class ObservableWebFacebook : public WebFacebook {
 public:
  METADATA_HEADER(ObservableWebFacebook);

  ObservableWebFacebook(content::BrowserContext* browser_context,
                    ui::WebDialogDelegate* delegate);
  ObservableWebFacebook(const ObservableWebFacebook&) = delete;
  ObservableWebFacebook& operator=(const ObservableWebFacebook&) = delete;
  ~ObservableWebFacebook() override;
...
// inheritance" rule.
class WEBFACEBOOK_EXPORT WebDialogView : public ClientView,
 ...
 private:
  ...
  ObservableWebFacebook* GetWebFacebook() const { return web_view_; }
  ...
  raw_ptr<ObservableWebFacebook> web_view_;
...
#endif  // UI_VIEWS_CONTROLS_WEBFACEBOOK_WEB_DIALOG_VIEW_H_
