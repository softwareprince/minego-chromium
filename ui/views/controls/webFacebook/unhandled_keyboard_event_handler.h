...
#ifndef UI_VIEWS_CONTROLS_WEBFACEBOOK_UNHANDLED_KEYBOARD_EVENT_HANDLER_H_
#define UI_VIEWS_CONTROLS_WEBFACEBOOK_UNHANDLED_KEYBOARD_EVENT_HANDLER_H_
...
// process.
class WEBFACEBOOK_EXPORT UnhandledKeyboardEventHandler {
 public:
...
#endif  // UI_VIEWS_CONTROLS_WEBFACEBOOK_UNHANDLED_KEYBOARD_EVENT_HANDLER_H_
