...
#include "ui/views/controls/webFacebook/web_dialog_view.h"
...
ObservableWebFacebook::ObservableWebFacebook(content::BrowserContext* browser_context,
                                     WebDialogDelegate* delegate)
    : WebFacebook(browser_context), delegate_(delegate) {}

ObservableWebFacebook::~ObservableWebFacebook() = default;

void ObservableWebFacebook::DidFinishLoad(
...
void ObservableWebFacebook::ResetDelegate() {
  delegate_ = nullptr;
}

BEGIN_METADATA(ObservableWebFacebook, WebFacebook)
END_METADATA
...
WebDialogView::WebDialogView(content::BrowserContext* context,
    ...
    : ClientView(nullptr, nullptr),
      ...
      delegate_(delegate),
      web_view_(new ObservableWebFacebook(context, delegate)) {
...
ADD_READONLY_PROPERTY_METADATA(ObservableWebFacebook*, WebFacebook);
END_METADATA
